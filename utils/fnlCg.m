...
% backtracking line-search
	...
	t = t0;
%         [f1, ~, RMSerr]  =  objective(FTXFMtx, FTXFMtdx, DXFMtx,
%         DXFMtdx,x,dx, t, params);replace ~ to useless_col to fit some old
% 		matlab version
        [f1, useless_col, RMSerr]  =  objective(FTXFMtx, FTXFMtdx, DXFMtx, DXFMtdx,x,dx, t, params); 
